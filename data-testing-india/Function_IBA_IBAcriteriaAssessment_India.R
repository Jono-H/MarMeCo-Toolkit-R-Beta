...
## INPUT data: dataframe (or equivalent) with species name and abundance estimate with units in mature individuals
...
"This function asssesses data against some of the single species global IBA criteria.
AREAS TO IMPROVE: Regional criteria and multispecies criteria."
...
Assess_IBA_criteria <- function(input.data,scientific.column,Best.estimate.mature.individuals){
  ...
  ifelse(file.exists("data-testing-india\\track2KBA_2021_RedListdatasets.Rdata"),
         load("data-testing-india\\track2KBA_2021_RedListdatasets.Rdata"),
