...
ras <- raster("./data-testing/Antarctica_5x5km/Antarctica_HighRes_5x5km_terra.tif")
...
## Save RasterStack
save(ColonyStack, 
            file=paste("./",species_for_analysis,"_",count_type,"_dist16_stack.Rdata", sep=""))
...
writeRaster(output, 
            paste("./",species_for_analysis,"_",count_type,"_A_dist16.tif", sep=""), overwrite = T)
...
maxValue(output)
writeRaster(output, 
            paste("./",species_for_analysis,"_",count_type,"_B_dist16.tif", sep=""), overwrite = T)
...
writeRaster(output, 
            paste("./",
                  species_for_analysis,"_",count_type,
                  "_C_dist16.tif", sep=""), overwrite = T)
