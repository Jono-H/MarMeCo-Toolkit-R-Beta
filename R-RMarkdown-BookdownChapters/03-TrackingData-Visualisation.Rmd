...
[NEED TO CREATE STATIC PLOT OUTPUTS FIRST - With colours denoting start and end points of tracks]

```{r track-vis-individual-shapefile, include = TRUE}
...
### When to remove or salvage data for a track individual
